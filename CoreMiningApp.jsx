...
function useTelegram() {
  ...
  return { tg, user, initData, isTelegram: !!tg, haptic, hapticNotify };
}
...
export default function CoreMiningApp() {
  const { tg, user, initData, isTelegram, haptic: hapticRaw, hapticNotify: hapticNotifyRaw } = useTelegram();
  ...
  const applyServerProgress = useCallback((p) => {
    ...
    if (Array.isArray(p.invitedFriends)) setInvitedFriends(p.invitedFriends);
